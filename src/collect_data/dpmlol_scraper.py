...
- SoloQ Leaderboards (top players by region: EUW, NA, KR)

LIMITATIONS:
- Champion matchups are blocked by Cloudflare (use OP.GG matchups instead)
- Leaderboards only work for EUW, NA, KR via home page loading
- Direct navigation to leaderboard/champion pages triggers Cloudflare
...
Usage:
    ...
    with DPMLOLScraper() as scraper:
        ...
        leaderboard = scraper.get_leaderboards_from_home()  # EUW, NA, KR
        scraper.save_data()
"""
